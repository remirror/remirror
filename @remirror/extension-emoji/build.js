...
const wrapInDefaultExport = (json, name) => `/* AUTOGENERATED FILE - DO NOT EDIT */
const ${name} = ${JSON.stringify(json, null, 2)}
...
const generateData = () => {
  ...
  writeFileSync(files.emojis, wrapInDefaultExport(emojis, 'emojis'));
  writeFileSync(files.categories, wrapInDefaultExport(categories, 'categories'));
