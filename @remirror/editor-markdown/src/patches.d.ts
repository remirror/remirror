declare module 'prosemirror-markdown' {
  ...
  export class MarkdownParser<S extends Schema = any> {
     ...
     * rules.
     */
    public parse(text: string): ProsemirrorNode<S>;
  }
  /**
  ...
  type MarkSerializerMethod<S extends Schema = any> = (
  ...
  export class MarkdownSerializer<S extends Schema = any> {
     ...
     */
    public nodes: { [name: string]: (p1: MarkdownSerializerState<S>, p2: ProsemirrorNode<S>) => void };
    /**
     * The mark serializer info.
     */
    public marks: { [key: string]: any };
    /**
     * Serialize the content of the given node to
     * [CommonMark](http://commonmark.org/).
     */
    public serialize(content: ProsemirrorNode<S>, options?: { [key: string]: any }): string;
  }
  /**
  ...
  export class MarkdownSerializerState<S extends Schema = any> {
     ...
     */
    public options: { tightLists?: boolean | null };
    /**
     ...
     */
    public closeBlock(node: ProsemirrorNode<S>): void;
    /**
     * Add the given text to the document. When escape is not `false`,
     * it will be escaped.
     */
    public text(text: string, escape?: boolean): void;

    /**
     * Render the given node as a block.
     */
    public render(node: ProsemirrorNode<S>): void;

    /**
     * Render the contents of `parent` as block nodes.
     */
    public renderContent(parent: ProsemirrorNode<S>): void;

    /**
     * Render the contents of `parent` as inline content.
     */
    public renderInline(parent: ProsemirrorNode<S>): void;
     ...
     */
    public renderList(node: ProsemirrorNode<S>, delim: string, firstDelim: (p: number) => string): void;
     ...
     */
    public getEnclosingWhitespace(text: string): { leading?: string | null; trailing?: string | null };
