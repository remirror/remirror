...
export abstract class BaseAction extends CommandLineAction {
  ...
  protected buildApiModel(): ApiModel {
    ...
    this.outputFolder = this.outputFolderParameter.value || `./${this.actionName}`;
   ...
   */
  private copyInheritedDocs(targetDocComment: tsdoc.DocComment, sourceDocComment: tsdoc.DocComment): void {
