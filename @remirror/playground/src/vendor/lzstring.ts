// This is a vendored file which was minified. Disable all our checks:
    ...
    i = {
      ...
      decompressFromUTF16: function (o) {
        return null == o
          ...
          : '' == o
          ? null
          : i._decompress(o.length, 16384, (r) => {
      ...
      decompressFromEncodedURIComponent: function (r) {
        return null == r
          ...
          ? null
          : ((r = r.replace(/ /g, '+')),
            i._decompress(r.length, 32, (n) => {
              return o(e, r.charAt(n));
            }));
      },
      compress: function (o) {
        return i._compress(o, 16, (o) => {
          return r(o);
        });
      },
      _compress: function (o, r, n) {
        ...
        for (i = 0; i < o.length; i += 1) {
          if (
            ...
            l--, 0 == l && ((l = 2 ** h), h++), (s[c] = f++), (a = String(u));
          }
        }
        if ('' !== a) {
          if (Object.prototype.hasOwnProperty.call(p, a)) {
      ...
      decompress: function (o) {
        return null == o
          ...
          : '' == o
          ? null
          : i._decompress(o.length, 32768, (r) => {
      ...
      _decompress: function (o, n, e) {
        ...
        for (f[3] = l, s = l, w.push(l); ; ) {
          ...
          w.push(v), (f[d++] = s + v.charAt(0)), h--, (s = v), 0 == h && ((h = 2 ** m), m++);
        }
      },
    };
  return i;
