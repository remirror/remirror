...
section of this quide I'll walk you through creating your own editor but for now there's enought to
learn in consuming the readily available components.

The most popular editor for a long time has been the **social editor**.

First make sure you've followed the instructions in the
