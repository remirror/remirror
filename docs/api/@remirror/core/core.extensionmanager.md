...
|  [schema](./core.extensionmanager.schema.md) |  | <code>EditorSchema&lt;NodeNames&lt;GExtension&gt;, MarkNames&lt;GExtension&gt;&gt;</code> | A shorthand method for retrieving the schema for this extension manager from the data. |
