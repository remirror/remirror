...
:::caution Advanced Topic The following is considered an advanced topic. If you are struggling to
understand some of the concepts don't feel sad. It can be hard to understand initially. :::
