...
declare namespace GatsbyTypes {
  ...
  enum SitePageFieldsEnum {
    ...
    context___relativePath = 'context.relativePath',
    context___frontmatter___title = 'context.frontmatter.title',
    context___frontmatter___fullWidth = 'context.frontmatter.fullWidth',
    ...
    pluginCreator___pluginOptions___typeDefsOutputPath = 'pluginCreator.pluginOptions.typeDefsOutputPath',
  ...
  enum SitePluginFieldsEnum {
    ...
    pluginOptions___typeDefsOutputPath = 'pluginOptions.typeDefsOutputPath',
  ...
  type SitePluginPluginOptions = {
    ...
    readonly typeDefsOutputPath: Maybe<Scalars['String']>;
  ...
  type SitePluginPluginOptionsFilterInput = {
    ...
    readonly typeDefsOutputPath: Maybe<StringQueryOperatorInput>;
