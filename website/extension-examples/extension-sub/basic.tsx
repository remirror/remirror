...
import ComponentSource from '!!raw-loader!../../../packages/storybook-react/stories/extension-sub/basic.tsx';

import ComponentStory from '../../../packages/storybook-react/stories/extension-sub/basic';
