...
import ComponentSource from '!!raw-loader!../../../packages/storybook-react/stories/react/replace-content-preserve-history.tsx';
...
const ExampleComponent = (): JSX.Element => {
  const story = (
    <BrowserOnly>
      {() => {
        const ComponentStory = require('../../../packages/storybook-react/stories/react/replace-content-preserve-history').default
