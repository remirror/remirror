...
- [#706](https://github.com/remirror/remirror/pull/706) [`9cb393ec5`](https://github.com/remirror/remirror/commit/9cb393ec58a8070dc43b7f2805c0920a04578f20) Thanks [@ifiokjr](https://github.com/ifiokjr)! - Improve the `EmojiExtension` API with `svgmoji`. Now emojis can be rendered as nodes or plain text and when rendered as nodes, the images are sourced via an SVG sprite from the `svgmoji` CDN.
