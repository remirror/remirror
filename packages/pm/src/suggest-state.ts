...
import { bool, object } from './node_modules/@remirror/core-helpers';
import {
...
} from './node_modules/@remirror/core-types';
import { transactionChanged } from './node_modules/@remirror/core-utils';
...
export class SuggestState<GSchema extends EditorSchema = any> {
  ...
  /**
   * Create the state for the `@remirror/pm` plugin.
   *
   * @remarks
   *
