...
- 2ff2a02e2: Expose a `toggleTableHeader` command, which only toggles the first row or column in a table.
...
- [#877](https://github.com/remirror/remirror/pull/877) [`033144c84`](https://github.com/remirror/remirror/commit/033144c849b861587a28d1de94b314e02571264a) Thanks [@ocavue](https://github.com/ocavue)! - Add a new `setTableCellBackground` command.
