export const defaultThemeVariables = `--rmr-color-background: #ffffff;
...
--rmr-color-shadow-2: rgba(10,31,68,0.10);
...
--rmr-font-family-default: system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", sans-serif;
...
--rmr-box-shadow-2: 0 1px 1px rgba(10,31,68,0.10);
