...
- f6185b950: Remove deprecated types `ClickHandler` and `ClickMarkHandler`, use `ClickEventHandler` and `ClickMarkEventHandler` respectively.
...
- 469d7ce8f: Remove deprecated types `ClickHandler` and `ClickMarkHandler`, use `ClickEventHandler` and `ClickMarkEventHandler` respectively.
...
- [#706](https://github.com/remirror/remirror/pull/706) [`b884f04ae`](https://github.com/remirror/remirror/commit/b884f04ae45090fc95155b4cdae5f98d0377cc19) Thanks [@ifiokjr](https://github.com/ifiokjr)! - Add `copy` and `paste` events to events extension.

* [#706](https://github.com/remirror/remirror/pull/706) [`0adccf9f0`](https://github.com/remirror/remirror/commit/0adccf9f0cabe8dd0386c2b2be99b3430ea47208) Thanks [@ifiokjr](https://github.com/ifiokjr)! - Add type signatures for each of the `EventHandler` events to `EventsExtension`.

- [#905](https://github.com/remirror/remirror/pull/905) [`270edd91b`](https://github.com/remirror/remirror/commit/270edd91ba6badf9468721e35fa0ddc6a21c6dd2) Thanks [@ifiokjr](https://github.com/ifiokjr)! - Add new events to `EventsExtension`. Also rename some exports.

### Patch Changes

- [#706](https://github.com/remirror/remirror/pull/706) [`0adccf9f0`](https://github.com/remirror/remirror/commit/0adccf9f0cabe8dd0386c2b2be99b3430ea47208) Thanks [@ifiokjr](https://github.com/ifiokjr)! - Prevent `hover` and `contextmenu` events from automatically calling `preventDefault()` when intercepted.

* [#926](https://github.com/remirror/remirror/pull/926) [`8b9522257`](https://github.com/remirror/remirror/commit/8b95222571ed2925be43d6eabe7340bbf9a2cd62) Thanks [@ocavue](https://github.com/ocavue)! - Fix `createMouseEventHandler` to not return undefined nodes.

- [#930](https://github.com/remirror/remirror/pull/930) [`4d3b81c6e`](https://github.com/remirror/remirror/commit/4d3b81c6e1b691f22061f7c152421b807965fc0d) Thanks [@ocavue](https://github.com/ocavue)! - Use `posAtDOM` instead of `posAtCoords` to get mouse event position.
...
- [`60776b1f`](https://github.com/remirror/remirror/commit/60776b1fc683408480a5e9502d104f79146a7977) [#734](https://github.com/remirror/remirror/pull/734) Thanks [@whawker](https://github.com/whawker)! - Add support for `mousedown` and `mouseup` events in `EventsExtension`
