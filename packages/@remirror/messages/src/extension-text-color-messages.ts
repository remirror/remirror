...
export const SET_COLOR_LABEL: MessageDescriptor = defineMessage({
  id: 'extension.command.set-text-color.label',
  comment: 'Label for color formatting command.',
  message: 'Text color',
});

export const SET_COLOR_DESCRIPTION: MessageDescriptor = defineMessage({
...
export const TRANSPARENT: MessageDescriptor = defineMessage({
  id: 'ui.text-color.transparent',
  comment: 'Transparent color label.',
  message: 'Transparent',
});

export const WHITE: MessageDescriptor = defineMessage({
  id: 'ui.text-color.white',
  comment: 'White color.',
  message: 'White',
});

export const BLACK: MessageDescriptor = defineMessage({
  id: 'ui.text-color.black',
  comment: 'Black color.',
  message: 'Black',
});

export const GRAY: MessageDescriptor = defineMessage({
