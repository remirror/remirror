...
export const SET_COLOR_DESCRIPTION: RemirrorMessage = /*i18n*/ {
...
export const TRANSPARENT: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.transparent',
  comment: 'Transparent color label.',
  message: 'Transparent',
};

export const WHITE: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.white',
  comment: 'White color.',
  message: 'White',
};

export const BLACK: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.black',
  comment: 'Black color.',
  message: 'Black',
};

export const GRAY: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.gray',
  comment: 'Gray color.',
  message: `Gray`,
};

export const GRAY_HUE: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.gray.hue',
  comment: 'Gray color hues.',
  message: `Gray {hue}`,
};

export const RED: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.red',
  comment: 'Red color.',
  message: `Red`,
};

export const RED_HUE: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.red.hue',
  comment: 'Red color hues.',
  message: `Red {hue}`,
};

export const PINK: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.pink',
  comment: 'Pink color.',
  message: `Pink`,
};

export const PINK_HUE: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.pink.hue',
  comment: 'Pink color hues.',
  message: `Pink {hue}`,
};

export const GRAPE: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.grape',
  comment: 'Grape color.',
  message: `Grape`,
};

export const GRAPE_HUE: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.grape.hue',
  comment: 'Grape color hues.',
  message: `Grape {hue}`,
};

export const VIOLET: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.violet',
  comment: 'Violet color.',
  message: `Violet`,
};

export const VIOLET_HUE: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.violet.hue',
  comment: 'Violet color hues.',
  message: `Violet {hue}`,
};

export const INDIGO: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.indigo',
  comment: 'Indigo color.',
  message: `Indigo`,
};

export const INDIGO_HUE: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.indigo.hue',
  comment: 'Indigo color hues.',
  message: `Indigo {hue}`,
};

export const BLUE: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.blue',
  comment: 'Blue color.',
  message: `Blue`,
};

export const BLUE_HUE: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.blue.hue',
  comment: 'Blue color hues.',
  message: `Blue {hue}`,
};

export const CYAN: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.cyan',
  comment: 'Cyan color.',
  message: `Cyan`,
};

export const CYAN_HUE: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.cyan.hue',
  comment: 'Cyan color hues.',
  message: `Cyan {hue}`,
};

export const TEAL: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.teal',
  comment: 'Teal color.',
  message: `Teal`,
};

export const TEAL_HUE: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.teal.hue',
  comment: 'Teal color hues.',
  message: `Teal {hue}`,
};

export const GREEN: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.green',
  comment: 'Green color.',
  message: `Green`,
};

export const GREEN_HUE: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.green.hue',
  comment: 'Green color hues.',
  message: `Green {hue}`,
};

export const LIME: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.lime',
  comment: 'Lime color.',
  message: `Lime`,
};

export const LIME_HUE: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.lime.hue',
  comment: 'Lime color hues.',
  message: `Lime {hue}`,
};

export const YELLOW: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.yellow',
  comment: 'Yellow color.',
  message: `Yellow`,
};

export const YELLOW_HUE: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.yellow.hue',
  comment: 'Yellow color hues.',
  message: `Yellow {hue}`,
};

export const ORANGE: RemirrorMessage = /*i18n*/ {
  id: 'ui.text-color.orange',
  comment: 'Orange color.',
  message: `Orange`,
};

export const ORANGE_HUE: RemirrorMessage = /*i18n*/ {
