...
export class DecorationSet<S extends Schema = any> {
   ...
   */
  public add(doc: ProsemirrorNode<S>, decorations: Decoration[]): DecorationSet<S>;
  /**
   * Create a new set that contains the decorations in this set, minus
   * the ones in the given array.
   */
  public remove(decorations: Decoration[]): DecorationSet<S>;
  /**
   ...
   */
  public static empty: DecorationSet;
}
/**
...
export class EditorView<S extends Schema = any> {
   ...
   */
  public dragging?: { slice: Slice<S>; move: boolean } | null;
  /**
   * The view's current [props](#view.EditorProps).
   */
  public props: DirectEditorProps<S>;
  /**
   * Update the view's props. Will immediately cause an update to
   * the DOM.
   */
  public update(props: DirectEditorProps<S>): void;
  /**
   * Update the view by updating existing props object with the object
   * given as argument. Equivalent to `view.update(Object.assign({},
   * view.props, props))`.
   */
  public setProps(props: DirectEditorProps<S>): void;
  /**
   * Update the editor's `state` prop, without touching any of the
   * other props.
   */
  public updateState(state: EditorState<S>): void;
  /**
   ...
   * directly).
   */
  public someProp(propName: string, f?: (prop: any) => any): any;
  /**
   ...
   */
  public coordsAtPos(pos: number): { left: number; right: number; top: number; bottom: number };
  /**
   ...
   * necessary).
   */
  public domAtPos(pos: number): { node: Node; offset: number };
  /**
   ...
   */
  public nodeDOM(pos: number): Node | null | undefined;
  /**
   ...
   */
  public posAtDOM(node: Node, offset: number, bias?: number | null): number;
  /**
   ...
   */
  public dispatch(tr: Transaction<S>): void;
  /**
   * View descriptions are data structures that describe the DOM that is
   * used to represent the editor's content.
   */
  public docView: NodeViewDesc;
}
/**
...
export interface EditorProps<S extends Schema = any> {
   ...
   */
  handleTextInput?: ((view: EditorView<S>, from: number, to: number, text: string) => boolean) | null;
  /**
   ...
   * thus be deleted).
   */
  handleDrop?: ((view: EditorView<S>, event: Event, slice: Slice<S>, moved: boolean) => boolean) | null;
  /**
  ...
  createSelectionBetween?:
    | ((view: EditorView<S>, anchor: ResolvedPos<S>, head: ResolvedPos<S>) => Selection<S> | null | undefined)
    | null;
  /**
...
export interface ViewDesc {
  ...
  parseRange(
    ...
    to: number,
    base?: number,
  ): { node?: Node; from: number; to: number; fromOffset: number; toOffset: number };
