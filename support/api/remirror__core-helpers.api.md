...
// @public
export const bool: <GValue>(value: GValue) => value is Exclude<GValue, Falsy>;
...
//
// @public
export const clone: <GObject extends object>(value: GObject) => GObject & PlainObject;
...
// @public
export const hasOwnProperty: <GObj extends object, GProperty extends string | number | symbol>(obj: GObj, key: GProperty) => obj is GObj & {
    GKey: unknown;
};

// @public
export const includes: <GType>(array: GType[] | readonly GType[], item: unknown, fromIndex?: number | undefined) => item is GType;
