...
// @public
export const isInstanceOf: <GConstructor extends AnyConstructor<unknown>>(
  Constructor: GConstructor,
) => (value: unknown) => value is InstanceType<GConstructor>;
...
export const uniqueBy: <GItem = any, GKey = any>(
  array: GItem[],
  getValue: string | (string | number)[] | ((item: GItem) => GKey),
  fromStart?: boolean,
) => GItem[];
