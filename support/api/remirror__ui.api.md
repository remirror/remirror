...
// @public
export const getFactory: (theme: RemirrorTheme) => <GReturn = any>(path: string | import("csstype").AnimationIterationCountProperty[], fallback?: any) => GReturn;
...
// @public
export const numberToPixels: (val: import("csstype").AnimationIterationCountProperty) => string;
