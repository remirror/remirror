...
// @public (undocumented)
export type FromFlexibleExtension<GValue extends FlexibleExtension> = GValue extends PrioritizedExtension<infer P> ? P : GValue extends AnyExtension ? GValue : never;
...
// @public
export type InferFlexibleExtension<GFlexible extends FlexibleExtension> = GFlexible extends PrioritizedExtension ? GFlexible['extension'] : GFlexible extends AnyExtension ? GFlexible : never;
