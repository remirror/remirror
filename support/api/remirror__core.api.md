...
export class ExtensionManager<GExtension extends AnyExtension = any>
  ...
  static create<GFlexibleList extends FlexibleExtension[]>(
  ...
  createState({
    ...
    stringHandler,
    fallback,
  }: Omit<CreateDocumentNodeParams, 'schema'>): EditorState<any>;
  // @internal
  ...
  readonly options: Record<
    NodeNames<GExtension> | MarkNames<GExtension> | PlainNames<GExtension>,
    PlainObject
  >;
  // @internal
...
// @public
export const isExtensionManager: (
  value: unknown,
) => value is ExtensionManager<import('./extension').Extension<any, any>>;
