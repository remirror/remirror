...
export const clean: ({
  schema,
  content,
}: CleanParams) => Node<import('prosemirror-model').Schema<string, string>> | Node<any>[] | undefined;
...
// @public
export const isTaggedNode: (
  val: unknown,
) => val is TaggedProsemirrorNode<import('prosemirror-model').Schema<string, string>>;
...
) => TaggedProsemirrorNode<import('prosemirror-model').Schema<string, string>>[];
...
export const renderEditor: <
  ...
  GOthers extends Extension<any, never>[],
  ...
  GPlainNodeNames extends 'paragraph' | 'doc' | 'p' | GPlainNodes[number]['name']
>(
  {
    plainMarks,
    plainNodes,
...
// @public
export const renderSSREditor: <GExtension extends import('@remirror/core').Extension<any, any> = any>(
...
) => (...content: TaggedContentWithText[]) => Slice<import('prosemirror-model').Schema<string, string>>;
