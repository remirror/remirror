...
export const getManagerFromComponentTree: ({
  ...
  prop,
  extraProps,
}: GetManagerFromComponentTreeParams) => Promise<ExtensionManager<any>>;
...
export const ManagedRemirrorProvider: {
  <GExtension extends import('@remirror/core').Extension<any, any> = any>({
    children,
    ...props
  }: ManagedRemirrorProviderProps<GExtension>): JSX.Element;
...
export const RemirrorExtension: <
  ...
  GOptions extends GConstructor['prototype']['_O']
>(
...
export const RemirrorProvider: {
  <GExtension extends import('@remirror/core').Extension<any, any> = any>({
    ...
    childAsRoot,
    ...props
  }: RemirrorProviderProps<GExtension>): JSX.Element;
  $$remirrorType: RemirrorType;
};
...
export const usePositioner: <GRefKey extends string = 'ref'>({
  positioner,
  ...rest
}: UsePositionerParams<GRefKey>) => import('../react-types').GetPositionerReturn<GRefKey>;
