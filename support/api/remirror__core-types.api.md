...
// @public
export type PartialWithRequiredKeys<GType extends object, GKeys extends Key<GType>> = Partial<Pick<GType, Exclude<keyof GType, GKeys>>> & Required<Pick<GType, GKeys>>;
...
// @public
export type WithVariants<GObject extends object> = GObject & {
    variant?: string;
};
