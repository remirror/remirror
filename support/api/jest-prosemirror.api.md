...
import { Plugin } from '@remirror/core-types';
...
// @public (undocumented)
export const a: (
  ...args: (string | pm.TaggedProsemirrorNode<any> | pm.TaggedFlatObject<any>)[]
) => pm.TaggedFlatObject<
  Schema<
    | 'doc'
    | 'orderedList'
...
// @public
export const apply: <GSchema extends import('prosemirror-model').Schema<string, string> = any>(
  taggedDoc: TaggedProsemirrorNode<GSchema>,
  command: CommandFunction<GSchema>,
  result?: TaggedProsemirrorNode<GSchema> | undefined,
) => ApplyReturn<GSchema>;
...
// @public (undocumented)
export const atomBlock: (
  ...args: (string | pm.TaggedProsemirrorNode<any> | pm.TaggedFlatObject<any>)[]
) => pm.TaggedProsemirrorNode<
  Schema<
    | 'doc'
    | 'orderedList'
    | 'bulletList'
...
// @public
export const backspace: <GSchema extends import('prosemirror-model').Schema<string, string> = any>({
  view,
  times,
...
// @public
export const createEditor: <GSchema extends import('prosemirror-model').Schema<string, string> = any>(
  taggedDoc: TaggedProsemirrorNode<GSchema>,
  { plugins, rules, autoClean, ...editorOptions }?: CreateEditorOptions,
) => {
  start: number;
  end: number;
...
// @public
export const createState: <GSchema extends Schema<string, string> = any>(
  taggedDoc: pm.TaggedProsemirrorNode<GSchema>,
  plugins?: import('prosemirror-state').Plugin<any, any>[],
) => EditorState<GSchema>;
...
// @public
export const fireEventAtPosition: <GSchema extends import('prosemirror-model').Schema<string, string> = any>({
  view,
  event,
  options,
  position,
}: FireEventAtPositionParams<GSchema>) => void;
...
// @public
export const initSelection: <GSchema extends Schema<string, string> = any>(
  taggedDoc: pm.TaggedProsemirrorNode<GSchema>,
) => GapCursor | Selection<GSchema> | null;

// @public
export const insertText: <GSchema extends import('prosemirror-model').Schema<string, string> = any>({
  view,
  text,
  start: from,
}: InsertTextParams<GSchema>) => void;
...
// @public
export const pasteContent: <GSchema extends import('prosemirror-model').Schema<string, string> = any>({
  view,
  content,
}: TestEditorViewParams<GSchema> & {
...
export const pmBuild: <
  GObj extends Record<string, pm.NodeTypeAttributes | pm.MarkTypeAttributes> = Record<
    string,
    pm.NodeTypeAttributes | pm.MarkTypeAttributes
  >,
...
>(
  ...
  (
    ...args: (string | pm.TaggedProsemirrorNode<any> | pm.TaggedFlatObject<any>)[]
  ) => pm.TaggedProsemirrorNode<Schema<GNodes, GMarks>>
> &
  Record<
    GMarks,
    (
      ...args: (string | pm.TaggedProsemirrorNode<any> | pm.TaggedFlatObject<any>)[]
    ) => pm.TaggedFlatObject<Schema<GNodes, GMarks>>
  > &
  {
    [P in keyof ({
      doc: {
    ...
    } & GObj)[P] extends pm.NodeTypeAttributes
      ? (
          ...args: (string | pm.TaggedProsemirrorNode<any> | pm.TaggedFlatObject<any>)[]
        ) => pm.TaggedProsemirrorNode<Schema<GNodes, GMarks>>
      : (
...
//
// @public
export const press: <GSchema extends import('prosemirror-model').Schema<string, string> = any>({
  view,
  char,
}: PressParams<GSchema>) => void;

// @public (undocumented)
export const prosemirrorMatchers: {
  toTransformNode(
    this: jest.MatcherUtils,
    command: CommandFunction<any>,
    { from, to }: CommandTransformation<any>,
  ):
    | {
        message: () => string;
        pass: boolean;
...
// @public
export const selectionFor: <GSchema extends Schema<string, string> = any>(
  taggedDoc: pm.TaggedProsemirrorNode<GSchema>,
) => Selection<GSchema>;
...
//
// @public
export const shortcut: <GSchema extends import('prosemirror-model').Schema<string, string> = any>({
  view,
  shortcut: text,
}: KeyboardShortcutParams<GSchema>) => void;
...
// @public (undocumented)
export const tdCursor: pm.TaggedProsemirrorNode<
  Schema<
    | 'doc'
    | 'orderedList'
    | 'bulletList'
...
// @public (undocumented)
export const tdEmpty: pm.TaggedProsemirrorNode<
  Schema<
    | 'doc'
    | 'orderedList'
    | 'bulletList'
...
// @public (undocumented)
export const thCursor: pm.TaggedProsemirrorNode<
  Schema<
    | 'doc'
    | 'orderedList'
    | 'bulletList'
...
// @public (undocumented)
export const thEmpty: pm.TaggedProsemirrorNode<
  Schema<
    | 'doc'
    | 'orderedList'
    | 'bulletList'
