...
export const cloneElement: <
  GProps extends PropsWithChildren<{
...
// @public
export const isManagedRemirrorProvider: <GOptions extends object = any>(
  value: unknown,
...
// @public
export const isRemirrorContextProvider: <GOptions extends object = any>(
  value: unknown,
) => value is RemirrorElement<GOptions>;
...
// @public
export const isRemirrorExtension: <GOptions extends object = any>(
  value: unknown,
) => value is RemirrorElement<GOptions>;

// @public
export const isRemirrorProvider: <GOptions extends object = any>(
  value: unknown,
) => value is RemirrorElement<GOptions>;
...
// @public
export const oneChildOnly: <GProps extends object = any>(
  value: unknown,
) => ReactElement<
  GProps,
  | string
