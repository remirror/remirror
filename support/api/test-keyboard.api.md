...
export const cleanKey: (
  ...
  import('./us-keyboard-layout').KeyDefinition,
  'keyCode' | 'code' | 'shiftKeyCode' | 'key' | 'location' | 'text'
>;
...
export const getModifierInformation: ({
  modifiers,
  isMac,
}: GetModifierInformationParams) => ModifierInformation;
...
// @public
export const isUSKeyboardCharacter: (
  char: unknown,
) => char is
  | '0'
  | 'Digit0'
...
// @public (undocumented)
export const usKeyboardLayout: Record<
  | '0'
  | 'Digit0'
  | '1'
  | 'Digit1'
