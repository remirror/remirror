...
Personally I find it intimidating when I open an interesting project only to be intimidated by a huge amount of files sitting in the root directory. I think this is an elegant solution way of avoiding that problem while
...
- `.size-limit.json` - This file is generated by running `pnpm run generate:config` in the root directory. It is possible
